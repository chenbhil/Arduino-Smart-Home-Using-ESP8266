...
function GetArduinoIO() {
    var cache = "&nocache=" + Math.random() * 1000000;
      ...
      if (this.status == 200) {
        if (this.responseXML != null) {
          ...
          if (this.responseXML.getElementsByTagName('LED')[2].childNodes[0].nodeValue == = "on") {
            document.getElementById("LED3").innerHTML = "LED 3 is ON (D2)";
            LED3_state = 1;
          }
          else {
            document.getElementById("LED3").innerHTML = "LED 3 is OFF (D2)";
            LED3_state = 0;
          }
          // LED 4
          if (this.responseXML.getElementsByTagName('LED')[3].childNodes[0].nodeValue == = "on") {
            document.getElementById("LED4").innerHTML = "LED 4 is ON (D4)";
            LED4_state = 1;
          }
          else {
            document.getElementById("LED4").innerHTML = "LED 4 is OFF (D4)";
            LED4_state = 0;
          }
        }
      }
